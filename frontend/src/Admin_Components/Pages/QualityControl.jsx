...
const QualityControlTable = () => {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ value }) => {
          ...
          return firstImage ? <img src={`http://localhost:3006/api/qualitycontrol/download/${firstImage}`} alt="qualitycontrol" className="w-32 object-cover h-20" /> : null;
        },
        disableSortBy: true,
      },
      {
  ...
  const fetchQualityControls = async () => {
    setLoading(true);
    try {
      const response = await axios.get('http://localhost:3006/api/qualitycontrol/getQualityControls', { withCredentials: true });
  ...
  const deleteQualityControl = async (id) => {
    try {
      const response = await axios.delete(`http://localhost:3006/api/qualitycontrol/deleteQualityControl?id=${id}`, { withCredentials: true });
  ...
  const fetchHeadings = async () => {
    try {
      const response = await axios.get('http://localhost:3006/api/pageHeading/heading?pageType=qualityControl', { withCredentials: true });
  ...
  const saveHeadings = async () => {
    try {
      await axios.put('http://localhost:3006/api/pageHeading/updateHeading?pageType=qualityControl', {
